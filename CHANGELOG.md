...
- Update uv to 0.10.4 [\#215](https://github.com/RegioHelden/django-scrubber/pull/215) (@regiohelden-dev)
- Update ruff to 0.15.1, ty to 0.0.17, ty VSCode to 2026.14.0 and uv to 0.10.2 [\#214](https://github.com/RegioHelden/django-scrubber/pull/214) (@regiohelden-dev)
- Update dependency mysqlclient to v2.2.8 [\#213](https://github.com/RegioHelden/django-scrubber/pull/213) (@renovate[bot])
...
- Add support for Django 6.0 release, remove support for EOL Django 5.0 and 5.1, remove support for EOL Python 3.9 [\#177](https://github.com/RegioHelden/django-scrubber/pull/177) (@lociii)
...
- Force ruff version in VSCode, add modulesync managed linting workflow, update VSCode ruff integration to 2025.30.0 and uv to 0.9.13 [\#174](https://github.com/RegioHelden/django-scrubber/pull/174) (@regiohelden-dev)
- Update github-reusable-workflows to 2.7.0 [\#173](https://github.com/RegioHelden/django-scrubber/pull/173) (@renovate[bot])
- Update dev and CI dependencies, handles CWE-407 and CWE-89 [\#171](https://github.com/RegioHelden/django-scrubber/pull/171) (@lociii)
- Update github-reusable-workflows to 2.7.0 and uv to 0.9.11 [\#170](https://github.com/RegioHelden/django-scrubber/pull/170) (@regiohelden-dev)
- chore\(deps\): update actions/checkout action to v6 [\#169](https://github.com/RegioHelden/django-scrubber/pull/169) (@renovate[bot])
- Update uv to 0.9.10 [\#168](https://github.com/RegioHelden/django-scrubber/pull/168) (@regiohelden-dev)
- Update uv to 0.9.9 [\#167](https://github.com/RegioHelden/django-scrubber/pull/167) (@regiohelden-dev)
- Update uv to 0.9.7 [\#166](https://github.com/RegioHelden/django-scrubber/pull/166) (@regiohelden-dev)
- Update uv to 0.9.6 [\#165](https://github.com/RegioHelden/django-scrubber/pull/165) (@regiohelden-dev)
- Update RegioHelden/github-reusable-workflows to 2.6.0 [\#164](https://github.com/RegioHelden/django-scrubber/pull/164) (@regiohelden-dev)
- Update RegioHelden/github-reusable-workflows to 2.6.0 [\#163](https://github.com/RegioHelden/django-scrubber/pull/163) (@renovate[bot])
- Update actions/download-artifact to v5 and uv to 0.9.5 [\#162](https://github.com/RegioHelden/django-scrubber/pull/162) (@regiohelden-dev)
- Update github-reusable-workflows to 2.5.0 [\#161](https://github.com/RegioHelden/django-scrubber/pull/161) (@regiohelden-dev)
- chore\(deps\): update regiohelden/github-reusable-workflows action to v2.5.0 [\#160](https://github.com/RegioHelden/django-scrubber/pull/160) (@renovate[bot])
- Update ruff-vscode to 2025.28.0 and uv to 0.9.2 [\#159](https://github.com/RegioHelden/django-scrubber/pull/159) (@regiohelden-dev)
- Update setup-uv action to v7 [\#158](https://github.com/RegioHelden/django-scrubber/pull/158) (@regiohelden-dev)
- chore\(deps\): update astral-sh/setup-uv action to v7 [\#157](https://github.com/RegioHelden/django-scrubber/pull/157) (@renovate[bot])
- Update Django to 5.2.7 [\#156](https://github.com/RegioHelden/django-scrubber/pull/156) (@lociii)
- chore\(deps\): update postgres docker tag to v18 [\#155](https://github.com/RegioHelden/django-scrubber/pull/155) (@renovate[bot])
- Update uv to 0.8.22 [\#154](https://github.com/RegioHelden/django-scrubber/pull/154) (@regiohelden-dev)
- Fix renovate json config [\#153](https://github.com/RegioHelden/django-scrubber/pull/153) (@regiohelden-dev)
- Update uv to 0.8.20, fix renovate config for modulesync managed workflow files [\#151](https://github.com/RegioHelden/django-scrubber/pull/151) (@regiohelden-dev)
- chore\(deps\): update astral-sh/setup-uv action to v6 [\#148](https://github.com/RegioHelden/django-scrubber/pull/148) (@renovate[bot])
- chore\(deps\): update actions/setup-python action to v6 [\#147](https://github.com/RegioHelden/django-scrubber/pull/147) (@renovate[bot])
- chore\(deps\): update actions/checkout action to v5 [\#146](https://github.com/RegioHelden/django-scrubber/pull/146) (@renovate[bot])
- chore\(deps\): update regiohelden/github-reusable-workflows action to v2.4.0 [\#145](https://github.com/RegioHelden/django-scrubber/pull/145) (@renovate[bot])
- chore\(deps\): update dependency python to v3.13.7 [\#144](https://github.com/RegioHelden/django-scrubber/pull/144) (@renovate[bot])
- chore\(deps\): pin dependency python to 3.12.11 [\#142](https://github.com/RegioHelden/django-scrubber/pull/142) (@renovate[bot])
- Update uv to 0.8.18 [\#141](https://github.com/RegioHelden/django-scrubber/pull/141) (@regiohelden-dev)
- Use renovate to keep custom workflow.yaml up to date [\#140](https://github.com/RegioHelden/django-scrubber/pull/140) (@regiohelden-dev)
- Update vscode-ruff to 2025.26.0 [\#139](https://github.com/RegioHelden/django-scrubber/pull/139) (@regiohelden-dev)
- Update uv to 0.8.17 [\#138](https://github.com/RegioHelden/django-scrubber/pull/138) (@regiohelden-dev)
- Update Django in test requirements to 5.2.6 [\#137](https://github.com/RegioHelden/django-scrubber/pull/137) (@lociii)
...
- Update uv to 0.7.18 [\#125](https://github.com/RegioHelden/django-scrubber/pull/125) (@regiohelden-dev)
- Update uv to 0.7.17 [\#124](https://github.com/RegioHelden/django-scrubber/pull/124) (@regiohelden-dev)
