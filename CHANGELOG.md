...
- Updates from modulesync [\#84](https://github.com/RegioHelden/django-scrubber/pull/84) (@regiohelden-dev)
- Updates from modulesync [\#83](https://github.com/RegioHelden/django-scrubber/pull/83) (@regiohelden-dev)
- Updates from modulesync [\#82](https://github.com/RegioHelden/django-scrubber/pull/82) (@regiohelden-dev)
- Updates from modulesync [\#81](https://github.com/RegioHelden/django-scrubber/pull/81) (@regiohelden-dev)
- Updates from modulesync [\#80](https://github.com/RegioHelden/django-scrubber/pull/80) (@regiohelden-dev)
- Updates from modulesync [\#79](https://github.com/RegioHelden/django-scrubber/pull/79) (@regiohelden-dev)
- Updates from modulesync [\#77](https://github.com/RegioHelden/django-scrubber/pull/77) (@regiohelden-dev)
- Add supported python versions to sync config [\#76](https://github.com/RegioHelden/django-scrubber/pull/76) (@lociii)
- Updates from modulesync [\#75](https://github.com/RegioHelden/django-scrubber/pull/75) (@regiohelden-dev)
...
- Updates from modulesync  [\#73](https://github.com/RegioHelden/django-scrubber/pull/73) (@regiohelden-dev)
